...
#import 2 data set one for deputies and one for political parties

#Loading the data
@st.cache   #enables the cache memory it will store the ram and it will make it very fast
...
#making the page interactive for the user by adding filter on the data
...
#proportion of women in the political party
